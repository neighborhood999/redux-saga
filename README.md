...
你可以在 [logo 目錄中](logo)找到不同的 Redux-Saga 官方 logo。

### Backers

每個月贊助我們並幫助我們持續下去。\[[Become a backer](https://opencollective.com/redux-saga#backer)\]
...
### Sponsors
成為一個贊助者我們會放置你的 logo 在我們的 Github README 並連結到你的網站。\[[Become a sponsor](https://opencollective.com/redux-saga#sponsor)\]
